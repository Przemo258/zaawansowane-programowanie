...
class House(Property):
    ...
    def __str__(self):
        return f'This is a House on {self.address} street that costs {self.price} with an plot {self.plot}'
...
class Flat(Property):
    ...
    def __str__(self):
        return f'This is a Flat on {self.address} street that costs {self.price} and is on {self.floor} floor'
